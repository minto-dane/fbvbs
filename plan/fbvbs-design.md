...
| `Measured` | `PARTITION_LOAD_IMAGE` | `Loaded` | ロード先メモリ確保成功 | コードと初期データを配置。authoritative loader/materializer を持たない build は `NOT_SUPPORTED_ON_PLATFORM` で fail-closed |
